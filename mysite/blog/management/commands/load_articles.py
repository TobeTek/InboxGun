...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--file',
            dest='file_name',
            default= os.path.join(os.path.dirname(__file__),r"../fixtures/articles.json"),
    ...
    def handle(self, *args, **options):
        ...
        if set(data.keys()) != {"title", "author", "body", "status"}:
            raise ValueError("The JSON file specified doesn't contain the necessary fields for Article model")
